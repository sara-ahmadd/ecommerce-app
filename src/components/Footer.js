...
function Footer() {
  return (
    <div className="footer bg-light mt-4 d-flex flex-column flex-sm-row">
      <div className="right-section w-100 w-sm-50 p-2">
        <div className="title">
      ...
      <div className="left-section p-2 w-100 w-sm-50 ">
